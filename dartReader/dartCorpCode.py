...
class DnCorpCode:
    ...
    def searchCorpCode(self, corpName):
        if not os.path.exists(self.binFileName):
            ...
            print(searchResult.iloc[0])
            print(searchResult.iloc[0][0])
            print(searchResult.iloc[0][1])
            print(searchResult.iloc[0][2])


if __name__ == '__main__':
    test = DnCorpCode()
    test.searchCorpCode('삼성전자')
